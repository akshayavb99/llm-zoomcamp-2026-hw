# LLM Zoomcamp Homework 3

For each question, all options are given, and the chosen option is in bold.
...
- 60-100 tokens
- 200-400 tokens
- **500+ tokens** (Observed around 1100 tokens with OpenAI gpt-5-nano)
...
- **About the same (within 20%)** (Around 1200 tokens with OpenAI gpt-5-nano)
- 2-5x more
- 10-20x more
- 50x more
